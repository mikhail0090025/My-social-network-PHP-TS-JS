const btn_change_desc: HTMLButtonElement | null = document.getElementById("btn_change_desc") as HTMLButtonElement;
const block_change_descr: HTMLElement | null = document.getElementById("block_change_descr") as HTMLElement;
let field_showed: boolean = false;
